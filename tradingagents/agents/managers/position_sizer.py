...
Runs after the Portfolio Manager. Converts the directional decision into a
concrete position size and entry/stop/target levels, anchored on the Technical
Analyst's ATR and scaled by the Macro Analyst's volatility regime and the risk
debate's conviction. Uses the same structured-output + graceful-fallback pattern
as the Portfolio Manager and Trader.
"""
